...
public class Decoder {
	...
	public static String typeDecode(String type){
    	...
    	public static String attendanceStatusDecode(String attendanceStatus){
		if(attendanceStatus.equals("A"))return "ABSENT";
		if(attendanceStatus.equals("P"))return "PRESENT";
